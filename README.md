...
The database is used for assessor-visible persistence, auditability, and player-facing history:
...
- Home screen difficulty leaderboards and recent match history are read from MySQL.
- The match-complete screen shows a saved post-game report, replay timeline, and leaderboard for the difficulty just played.

Useful database read APIs:
